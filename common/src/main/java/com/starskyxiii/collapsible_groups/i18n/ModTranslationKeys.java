...
public final class ModTranslationKeys {
	...
	public static final String EDITOR_RULES_DELETE = "collapsible_groups.editor.rules.delete";

	public static final String EDITOR_RULES_ERROR_ALL_EMPTY = "collapsible_groups.editor.rules.error.all_empty";

	public static final String EDITOR_RULES_ERROR_ANY_EMPTY = "collapsible_groups.editor.rules.error.any_empty";

	public static final String EDITOR_RULES_ERROR_COMPONENT_PATH_BLANK = "collapsible_groups.editor.rules.error.component_path_blank";

	public static final String EDITOR_RULES_ERROR_COMPONENT_PATH_GRAMMAR = "collapsible_groups.editor.rules.error.component_path_grammar";

	public static final String EDITOR_RULES_ERROR_COMPONENT_PATH_TYPE_BLANK = "collapsible_groups.editor.rules.error.component_path_type_blank";

	public static final String EDITOR_RULES_ERROR_COMPONENT_PATH_TYPE_INVALID = "collapsible_groups.editor.rules.error.component_path_type_invalid";

	public static final String EDITOR_RULES_ERROR_COMPONENT_PATH_VALUE_BLANK = "collapsible_groups.editor.rules.error.component_path_value_blank";
	...
	public static final String EDITOR_RULES_ERROR_HAS_COMPONENT_TYPE_INVALID = "collapsible_groups.editor.rules.error.has_component_type_invalid";

	public static final String EDITOR_RULES_ERROR_HAS_COMPONENT_VALUE_BLANK = "collapsible_groups.editor.rules.error.has_component_value_blank";

	public static final String EDITOR_RULES_ERROR_INVALID_NAMESPACE = "collapsible_groups.editor.rules.error.invalid_namespace";

	public static final String EDITOR_RULES_ERROR_INVALID_RESOURCE_LOCATION = "collapsible_groups.editor.rules.error.invalid_resource_location";

	public static final String EDITOR_RULES_ERROR_INVALID_TYPE = "collapsible_groups.editor.rules.error.invalid_type";

	public static final String EDITOR_RULES_ERROR_MISSING_TYPE = "collapsible_groups.editor.rules.error.missing_type";
	...
	public static final String EDITOR_RULES_FIELD_STACK = "collapsible_groups.editor.rules.field.stack";

	public static final String EDITOR_RULES_FIELD_TAG = "collapsible_groups.editor.rules.field.tag";

	public static final String EDITOR_RULES_FIELD_TYPE = "collapsible_groups.editor.rules.field.type";

	public static final String EDITOR_RULES_FIELD_VALUE = "collapsible_groups.editor.rules.field.value";
