...
public record EditorPreviewSummary(int itemCount, int fluidCount, int genericCount) {
	public static EditorPreviewSummary of(int itemCount, int fluidCount, int genericCount) {
		return new EditorPreviewSummary(
