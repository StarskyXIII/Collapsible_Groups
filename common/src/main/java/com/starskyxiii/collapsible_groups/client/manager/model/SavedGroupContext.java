...
public record SavedGroupContext(String groupId, SaveKind kind, String warningKey) {
	public SavedGroupContext(String groupId, SaveKind kind) {
		this(groupId, kind, null);
	}
