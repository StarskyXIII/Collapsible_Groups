...
public record EditorShellLayout(
	Rect header,
	Rect footer,
	Rect editorPanel,
	Rect previewPanel,
	...
	public static EditorShellLayout compute(int screenWidth, int screenHeight) {
		return compute(screenWidth, screenHeight, false, 0);
	}

	public static EditorShellLayout compute(int screenWidth, int screenHeight, boolean showDisableSourceOption) {
		return compute(screenWidth, screenHeight, showDisableSourceOption, 0);
	}

	public static EditorShellLayout compute(
		int screenWidth,
		int screenHeight,
		...
		// the hide-used control is a drawSwitch (fixed 22px visual, centered in
		...
		return new EditorShellLayout(header, footer, editorPanel, previewPanel, actionTitle, headerPreview,
