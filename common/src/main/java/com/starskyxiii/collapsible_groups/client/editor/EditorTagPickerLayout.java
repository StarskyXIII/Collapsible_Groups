...
record EditorTagPickerLayout(Rect cancel, Rect manual, Rect confirm) {
	static EditorTagPickerLayout create(Rect bounds, int cancelWidth, int manualWidth, int confirmWidth) {
		...
		return new EditorTagPickerLayout(cancel, manual, confirm);
	}
