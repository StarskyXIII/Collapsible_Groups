...
public final class EditorChrome {
	...
	public static void drawTab(GuiGraphicsExtractor g, Font font, Rect rect, String label,
	...
	public static void drawChip(GuiGraphicsExtractor g, Font font, Rect rect, String label,
	...
	private static void drawOutline(GuiGraphicsExtractor g, Rect rect, int color) {
