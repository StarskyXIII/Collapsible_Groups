...
final class EditorGroupOwnershipHelper {
	 ...
	 *       {@code GroupRegistry.getAllIncludingKubeJs}); the first group whose
	 *       {@code matches} predicate succeeds is the winner, matching
	 *       {@code GroupRegistry.findGroup}'s first-match rule.</li>
	 * </ul>
	 ...
	 */
	static <T> Map<T, List<String>> buildOwnership(
		List<T> entries,
