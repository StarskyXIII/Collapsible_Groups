...
public final class SettingsRowLayout {
	/** Button/switch design height; must match {@link OreUiRenderer#BUTTON_DESIGN_HEIGHT}. */
	public static final int BUTTON_HEIGHT = OreUiRenderer.BUTTON_DESIGN_HEIGHT;
