...
/**
 * Wraps an individual fluid ingredient belonging to a collapsible group.
...
public class FluidChildElement implements IElement<FluidStack>, PreRenderIngredientGridElement {
	...
	@Override
	public ITypedIngredient<FluidStack> getTypedIngredient() { return delegate.getTypedIngredient(); }
	...
	public void getTooltip(JeiTooltip tooltip, IngredientGridTooltipHelper tooltipHelper,
	                       IIngredientRenderer<FluidStack> renderer, IIngredientHelper<FluidStack> helper) {
