...
public class FluidChildElement implements IElement<IJeiFluidIngredient>, PreRenderIngredientGridElement {
	private final IngredientElement<IJeiFluidIngredient> delegate;
	...
	@Override public ITypedIngredient<IJeiFluidIngredient> getTypedIngredient() { return delegate.getTypedIngredient(); }
	...
	@Override public void getTooltip(JeiTooltip tooltip, IngredientGridTooltipHelper helper, IIngredientRenderer<IJeiFluidIngredient> renderer, IIngredientHelper<IJeiFluidIngredient> ingredientHelper) { delegate.getTooltip(tooltip, helper, renderer, ingredientHelper); }
