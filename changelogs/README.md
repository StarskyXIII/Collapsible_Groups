...
Both values come from `gradle.properties`. For example, Minecraft `1.21.1` and
mod version `2.0.0-beta1` use `changelogs/1.21.1/2.0.0-beta1.md`.
All three loader uploads receive the same file, including any loader-specific
